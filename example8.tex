...
\section{Grade 11 Ex.16.2 example 8\\
Question 8}
...
Therefore , the events are pair-wise disjoint ,i.e, thay are mutually exclusive.Hence ,A,B and C form a set of mutually exclusive and exhaustive events.
